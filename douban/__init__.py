...
class CollectionEntry(gdata.GDataEntry):
	...
	def __init__(self, status=None, subject=None, tag=None, rating=None, attribute=None, **kwargs):
		gdata.GDataEntry.__init__(self, **kwargs)
		self.status = status
		self.subject = subject
		self.tags = tag or []
...
class When(atom.AtomBase):
	...
	def __init__(self, start_time=None, end_time=None, extension_elements=None, extension_attributes=None, text=None):
...
class Where(atom.AtomBase):
	...
	def __init__(self, value_string=None, extension_elements=None, extension_attributes=None, text=None):
